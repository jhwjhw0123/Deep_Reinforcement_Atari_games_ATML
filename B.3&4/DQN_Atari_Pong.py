...
Load_path = '../../Data/B.3/'
Model_path = '../../Model/B.3/Pong/'
Save_path = '../../result/B.3/Pong/'
        ...
        for c_episode in range(n_episode):
            ...
            for t in range(episode_len):
                ...
                if t<4:
                    ...
                    stat_obs, reward, done, info = env.step(action)
                #Process the frames
                grey_obs = Frame_pre_processing(stat_obs,Pong_Flag=True)
                #Append frame
