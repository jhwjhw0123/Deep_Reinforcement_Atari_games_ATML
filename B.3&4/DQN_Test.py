...
Load_path = '../../Data/B.2/'
Model_path = '../../Model/B.3&4/Boxing/'
Save_path = '../../Model/B.3&4/Boxing/'
...
buffer_len = 2000
frame_dim = 4
action_space_size = 18 #6,9,18
#Deep Learning Variables
batch_size = 28
LR = 1e-4
img_size = 28  #64 for Pong
...
def online_train_neural_network(s_current,r):
    ...
    with tf.Session() as sess:
        saver = tf.train.Saver()
        saver.restore(sess, Model_path + 'CNN_Model.checkpoint')
        for c_episode in range(n_episode):
            ...
            for t in range(episode_len):
                ...
                total_score += reward
                discounted_socre += math.pow(Gamma,t)*reward
                run_eps_len = t + 1
                ...
                if done == True:
                    ...
                    Discounted_score_collection.append(discounted_socre)
                    Frame_count_collection.append(run_eps_len)
                    break
